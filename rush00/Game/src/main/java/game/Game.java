...
public class Game {
    ...
    public void run() {
        ...
        DownloadProperties downloader = new DownloadProperties(profile);
        ...
        MapInit itMap = new MapInit(map, enemiesCount, wallsCount, size);
        char[][] array = itMap.init();

        RunGame runGame = new RunGame(array, map, size, profile);
        runGame.run();
    }
